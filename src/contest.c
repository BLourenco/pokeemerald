...
static const u16 contestPrizeTable[CONTEST_RANKS_COUNT][CONTEST_CATEGORIES_COUNT] = {
    [CONTEST_RANK_NORMAL] = {
        [CONTEST_CATEGORY_COOL]   = ITEM_FIGY_BERRY,
        [CONTEST_CATEGORY_BEAUTY] = ITEM_WIKI_BERRY,
        [CONTEST_CATEGORY_CUTE]   = ITEM_MAGO_BERRY,
        [CONTEST_CATEGORY_SMART]  = ITEM_AGUAV_BERRY,
        [CONTEST_CATEGORY_TOUGH]  = ITEM_IAPAPA_BERRY
    },
    [CONTEST_RANK_SUPER] = {
        [CONTEST_CATEGORY_COOL]   = ITEM_POMEG_BERRY,
        [CONTEST_CATEGORY_BEAUTY] = ITEM_KELPSY_BERRY,
        [CONTEST_CATEGORY_CUTE]   = ITEM_QUALOT_BERRY,
        [CONTEST_CATEGORY_SMART]  = ITEM_HONDEW_BERRY,
        [CONTEST_CATEGORY_TOUGH]  = ITEM_GREPA_BERRY
    },
    [CONTEST_RANK_HYPER] = {
        [CONTEST_CATEGORY_COOL]   = ITEM_SPELON_BERRY,
        [CONTEST_CATEGORY_BEAUTY] = ITEM_PAMTRE_BERRY,
        [CONTEST_CATEGORY_CUTE]   = ITEM_WATMEL_BERRY,
        [CONTEST_CATEGORY_SMART]  = ITEM_DURIN_BERRY,
        [CONTEST_CATEGORY_TOUGH]  = ITEM_BELUE_BERRY
    },
    [CONTEST_RANK_MASTER] = {
        [CONTEST_CATEGORY_COOL]   = ITEM_LIECHI_BERRY,
        [CONTEST_CATEGORY_BEAUTY] = ITEM_GANLON_BERRY,
        [CONTEST_CATEGORY_CUTE]   = ITEM_SALAC_BERRY,
        [CONTEST_CATEGORY_SMART]  = ITEM_PETAYA_BERRY,
        [CONTEST_CATEGORY_TOUGH]  = ITEM_APICOT_BERRY
    },
    [CONTEST_RANK_LINK] = {
        [CONTEST_CATEGORY_COOL]   = ITEM_LIECHI_BERRY,
        [CONTEST_CATEGORY_BEAUTY] = ITEM_GANLON_BERRY,
...
bool8 SaveContestWinner(u8 rank)
{
    ...
    if (rank != CONTEST_SAVE_FOR_ARTIST)
    {
        ...
        // Used to save any winner for any of the Contest Halls
        // or the Museum but excludes the temporary save
        // used by the artist
        switch (hall)
        {
            ...
            case MAP_LAVARIDGE_TOWN_CONTEST_LOBBY:
                ...
                break;
            default:
                id = GetContestWinnerSaveIdx(rank, TRUE);
                break;
        }
...
u8 GetContestWinnerSaveIdx(u8 rank, bool8 shift)
{
    ...
    case CONTEST_RANK_MASTER:
        ...
        return CONTEST_WINNER_LILYCOVE_HALL_1 - 1;
    default:
...
void GetContestPrize(void)
{
    gSpecialVar_Result = contestPrizeTable[gSpecialVar_ContestRank][gSpecialVar_ContestCategory];
}
