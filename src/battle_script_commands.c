...
static const u16 sNaturePowerMoves[] =
{
    ...
    [BATTLE_TERRAIN_MOUNTAIN_CHIMNEY]       = MOVE_ERUPTION,
    ...
    [BATTLE_TERRAIN_STADIUM_PYRE]           = MOVE_SHADOW_BALL,
...
static void Cmd_getsecretpowereffect(void)
{
    ...
    case BATTLE_TERRAIN_MOUNTAIN_CHIMNEY:
        gBattleScripting.moveEffect = MOVE_EFFECT_BURN;   
        break;     
