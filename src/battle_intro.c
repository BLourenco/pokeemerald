...
static const TaskFunc sBattleIntroSlideFuncs[] =
{
    ...
    [BATTLE_TERRAIN_GRASS_SOOT]           = BattleIntroSlide1,
    [BATTLE_TERRAIN_GRASS_COLD]           = BattleIntroSlide1,
    [BATTLE_TERRAIN_LONG_GRASS_OVERGROWN] = BattleIntroSlide1,
    [BATTLE_TERRAIN_CAVE_RUSTURF]         = BattleIntroSlide1,
    [BATTLE_TERRAIN_CAVE_VOLCANO]         = BattleIntroSlide3,
    [BATTLE_TERRAIN_CAVE_CLAY]            = BattleIntroSlide1,
    [BATTLE_TERRAIN_CAVE_METEOR_FALLS]    = BattleIntroSlide1,
    [BATTLE_TERRAIN_CAVE_ICE]             = BattleIntroSlide1,
    [BATTLE_TERRAIN_STADIUM_PYRE]         = BattleIntroSlide3,
    [BATTLE_TERRAIN_GRASS_JAGGED_PASS]    = BattleIntroSlide1,
    [BATTLE_TERRAIN_MOUNTAIN_CHIMNEY]     = BattleIntroSlide1,
};
