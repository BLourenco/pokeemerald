...
static const u8 sPartyMenuSpriteCoords[PARTY_LAYOUT_COUNT][PARTY_SIZE][4 * 2] =
{
    [PARTY_LAYOUT_SINGLE] = 
    {
        { 20,  14,  14,  33,  64,  33,  14,  15},
        {140,  22, 126,  41, 176,  41, 134,  23},
        { 20,  54,  14,  73,  64,  73,  14,  55},
        {140,  62, 126,  81, 176,  81, 134,  63},
        { 20,  94,  14, 113,  64, 113,  14,  95},
        {140, 102, 126, 121, 176, 121, 134, 103},
    },
    [PARTY_LAYOUT_DOUBLE] = 
    {
        { 16,  24,  35,  35,  33,  52,  16,  18},
        { 16,  80,  35,  91,  33, 108,  16,  74},
        {104,  18, 121,  28, 185,  28, 102,  25},
        {104,  50, 121,  60, 185,  60, 102,  57},
        {104,  82, 121,  92, 185,  92, 102,  89},
        {104, 114, 121, 124, 185, 124, 102, 121},
    },
    [PARTY_LAYOUT_MULTI] = 
    {
        { 16,  24,  35,  35,  33,  52,  16,  18},
...
static const u8 sOtherSlotsTileNums[] = {24, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 26,
                                         32, 33, 33, 33, 33, 33, 33, 33, 33, 52, 53, 51, 51, 51, 51, 51, 51, 54,
                                         43, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 44, 45};

static const u8 sOtherSlotsTileNums_Egg[] = {24, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 26,
...
static const u8 sEmptySlotTileNums[] = {21, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 23,
 ...
 //Custom party menu
static const u8 sEqualMainSlotTileNums[] =      {24, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 26,
                                                 32, 33, 33, 33, 33, 33, 33, 33, 33, 33, 33, 33, 33, 33, 34,
                                                 32, 33, 33, 33, 33, 52, 53, 51, 51, 51, 51, 51, 51, 51, 54,
                                                 40, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 42,
                                                 55, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 57};

static const u8 sEqualMainSlotTileNums_Egg[] =  {24, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 25, 26,
                                                 32, 33, 33, 33, 33, 33, 33, 33, 33, 33, 33, 33, 33, 33, 34,
                                                 32, 33, 33, 33, 33, 33, 33, 33, 33, 33, 33, 33, 33, 33, 34,
                                                 40, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 41, 42,
                                                 55, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 56, 57};

static const u8 sEqualEmptySlotTileNums[] = {21, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 22, 23,
                                             30, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 31,
                                             30, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 31,
                                             30, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 14, 31,
                                             37, 38, 38, 38, 38, 38, 38, 38, 38, 38, 38, 38, 38, 38, 39};
//
// Palette offsets
...
static const u16 sTMHMMoves[] =
{
    ...
    [ITEM_TM51 - ITEM_TM01] = MOVE_LOW_SWEEP,
    ...
    [ITEM_TM77 - ITEM_TM01] = MOVE_RETALIATE,
    ...
    [ITEM_TM83 - ITEM_TM01] = MOVE_LEECH_LIFE,
    ...
    [ITEM_TM94 - ITEM_TM01] = MOVE_FLAME_CHARGE,
    ...
    [ITEM_TM100 - ITEM_TM01] = MOVE_ECHOED_VOICE,
    [ITEM_TM101 - ITEM_TM01] = MOVE_AVALANCHE,
    [ITEM_TM102 - ITEM_TM01] = MOVE_NATURAL_GIFT,
    [ITEM_TM103 - ITEM_TM01] = MOVE_PLAY_ROUGH,
    [ITEM_TM104 - ITEM_TM01] = MOVE_SOLAR_BLADE,
    [ITEM_TM105 - ITEM_TM01] = MOVE_MUD_SHOT,
    [ITEM_TM106 - ITEM_TM01] = MOVE_THUNDER_FANG,
    [ITEM_TM107 - ITEM_TM01] = MOVE_ICE_FANG,
    [ITEM_TM108 - ITEM_TM01] = MOVE_FIRE_FANG,
    [ITEM_TM109 - ITEM_TM01] = MOVE_PSYCHO_CUT,
    [ITEM_TM110 - ITEM_TM01] = MOVE_HEX,
    [ITEM_TM111 - ITEM_TM01] = MOVE_DRAINING_KISS,
    [ITEM_TM112 - ITEM_TM01] = MOVE_GRASSY_TERRAIN,
    [ITEM_TM113 - ITEM_TM01] = MOVE_MISTY_TERRAIN,
    [ITEM_TM114 - ITEM_TM01] = MOVE_ELECTRIC_TERRAIN,
    [ITEM_TM115 - ITEM_TM01] = MOVE_PSYCHIC_TERRAIN,
    [ITEM_TM116 - ITEM_TM01] = MOVE_MYSTICAL_FIRE,
    [ITEM_TM117 - ITEM_TM01] = MOVE_AIR_SLASH,
    [ITEM_TM118 - ITEM_TM01] = MOVE_SPIKES,
    [ITEM_TM119 - ITEM_TM01] = MOVE_BUG_BUZZ,
    [ITEM_TM120 - ITEM_TM01] = MOVE_POWER_GEM,
