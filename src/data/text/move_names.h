const u8 gMoveNames[MOVES_COUNT][MOVE_NAME_LENGTH + 1] =
{
    ...
    [MOVE_PARABOLIC_CHARGE] = _("ParabolChrg"),
    ...
    [MOVE_HYPERSPACE_HOLE] = _("HyperS. Hole"),
    ...
    [MOVE_PRECIPICE_BLADES] = _("Prec. Blades"),
    [MOVE_DRAGON_ASCENT] = _("DragonAscent"),
    [MOVE_HYPERSPACE_FURY] = _("HyperS. Fury"),
    [MOVE_SHORE_UP] = _("Shore Up"),
    [MOVE_FIRST_IMPRESSION] = _("1st Impress."),
    [MOVE_BANEFUL_BUNKER] = _("BanefulBunk."),
    [MOVE_SPIRIT_SHACKLE] = _("SpiritShack."),
    [MOVE_DARKEST_LARIAT] = _("Dark. Lariat"),
    [MOVE_SPARKLING_ARIA] = _("Sparkl. Aria"),
    ...
    [MOVE_STOMPING_TANTRUM] = _("StompTantrum"),
    ...
    [MOVE_NATURES_MADNESS] = _("Nat. Madness"),
    ...
    [MOVE_DOUBLE_IRON_BASH] = _("Dbl IronBash"),
    //GEN 8
    ...
    [MOVE_BEHEMOTH_BLADE] = _("Behem. Blade"),
    [MOVE_BEHEMOTH_BASH] = _("Behem. Bash"),
    ...
    [MOVE_FALSE_SURRENDER] = _("False Surr."),
    [MOVE_METEOR_ASSAULT] = _("Met. Assault"),
    [MOVE_ETERNABEAM] = _("Eternabeam"),
    [MOVE_STEEL_BEAM] = _("Steel Beam"),
    [MOVE_EXPANDING_FORCE] = _("Expan. Force"),
    ...
    [MOVE_MISTY_EXPLOSION] = _("Misty Explo."),
    ...
    [MOVE_BURNING_JEALOUSY] = _("Brn.Jealousy"),
    ...
    [MOVE_SURGING_STRIKES] = _("Surg. Strike"),
    ...
    [MOVE_ASTRAL_BARRAGE] = _("Ast. Barrage"),
