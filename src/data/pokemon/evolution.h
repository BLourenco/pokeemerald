const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_PIKACHU]               = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_RAICHU},
                                       {EVO_ITEM_HOLD, ITEM_STRANGE_SOUVENIR, SPECIES_RAICHU_ALOLAN}},
    ...
    [SPECIES_KADABRA]               = {{EVO_ITEM_HOLD, ITEM_TWISTED_SPOON, SPECIES_ALAKAZAM}},
    [SPECIES_ALAKAZAM]              = {{EVO_MEGA_EVOLUTION, ITEM_ALAKAZITE, SPECIES_ALAKAZAM_MEGA}},
    [SPECIES_MACHOP]                = {{EVO_LEVEL, 28, SPECIES_MACHOKE}},
    [SPECIES_MACHOKE]               = {{EVO_ITEM_HOLD, ITEM_MUSCLE_BAND, SPECIES_MACHAMP}},
    ...
    [SPECIES_GRAVELER]              = {{EVO_ITEM_HOLD, ITEM_PROTECTOR, SPECIES_GOLEM}},
    ...
    [SPECIES_EXEGGCUTE]             = {{EVO_ITEM, ITEM_LEAF_STONE, SPECIES_EXEGGUTOR},
                                       {EVO_ITEM_HOLD, ITEM_STRANGE_SOUVENIR, SPECIES_EXEGGUTOR_ALOLAN}},
    [SPECIES_CUBONE]                = {{EVO_LEVEL, 28, SPECIES_MAROWAK},
                                       {EVO_ITEM_HOLD, ITEM_STRANGE_SOUVENIR, SPECIES_MAROWAK_ALOLAN}},
    [SPECIES_LICKITUNG]             = {{EVO_MOVE, MOVE_ROLLOUT, SPECIES_LICKILICKY}},
    [SPECIES_KOFFING]               = {{EVO_LEVEL, 35, SPECIES_WEEZING},
                                       {EVO_SPECIFIC_MAP, MAP_ALTERING_CAVE_HIDDEN, SPECIES_WEEZING_GALARIAN}},
    ...
    [SPECIES_EEVEE]                 = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_JOLTEON},
                                       ...
                                       {EVO_SPECIFIC_MAP, MAP_OVERGROWN_FOREST, SPECIES_LEAFEON},
                                       {EVO_SPECIFIC_MAP, MAP_SHOAL_CAVE_SUMMIT, SPECIES_GLACEON}},
    ...
    [SPECIES_MIME_JR]               = {{EVO_MOVE, MOVE_MIMIC, SPECIES_MR_MIME},
                                       {EVO_SPECIFIC_MAP, MAP_ALTERING_CAVE_HIDDEN, SPECIES_MR_MIME_GALARIAN}},
    ...
    [SPECIES_BOLDORE]               = {{EVO_ITEM_HOLD, ITEM_PROTECTOR, SPECIES_GIGALITH}},
    ...
    [SPECIES_GURDURR]               = {{EVO_ITEM_HOLD, ITEM_MUSCLE_BAND, SPECIES_CONKELDURR}},
    ...
    [SPECIES_PHANTUMP]              = {{EVO_ITEM, ITEM_DUSK_STONE, SPECIES_TREVENANT}},
    ...
    [SPECIES_CRABRAWLER]            = {{EVO_SPECIFIC_MAP, MAP_SHOAL_CAVE_LOW_TIDE_ICE_ROOM, SPECIES_CRABOMINABLE},
	                                   {EVO_SPECIFIC_MAP, MAP_SHOAL_CAVE_SUMMIT, SPECIES_CRABOMINABLE}, // Shoal Sanctuary
    ...
    [SPECIES_GRAVELER_ALOLAN]       = {{EVO_ITEM_HOLD, ITEM_PROTECTOR, SPECIES_GOLEM_ALOLAN}},
