...
const u8 gText_PkmnNotHoldingItem[] = _("{STR_VAR_1} isn't holding\nanything.{PAUSE_UNTIL_PRESS}");
const u8 gText_EggsCantHoldItems[] = _("Eggs can't hold items.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_EggFromHotSprings[] = _("A Pokémon egg received\nas a gift.");
...
const u8 gText_Prizes[] = _("Prizes");
const u8 gText_ExplainChallenge[] = _("Explain Challenge");
...
const u8 gText_LevelBall[] = _("Level Ball");
const u8 gText_LureBall[] = _("Lure Ball");
const u8 gText_LoveBall[] = _("Love Ball");
const u8 gText_FriendBall[] = _("Friend Ball");
const u8 gText_MoonBall[] = _("Moon Ball");
const u8 gText_HeavyBall[] = _("Heavy Ball");
const u8 gText_FastBall[] = _("Fast Ball");
...
const u8 gText_SoftboiledFree[] = _("Soft-boiled{CLEAR_TO 0x4E}FREE");
...
const u8 gText_DynamicPunchFree[] = _("Dynamic Punch{CLEAR_TO 0x4E}FREE");
const u8 gText_DoubleEdgeFree[] = _("Double-Edge{CLEAR_TO 0x4E}FREE");
const u8 gText_RolloutFree[] = _("Rollout{CLEAR_TO 0x4E}FREE");
const u8 gText_FuryCutterFree[] = _("Fury Cutter{CLEAR_TO 0x4E}FREE");
const u8 gText_MetronomeFree[] = _("Metronome{CLEAR_TO 0x4E}FREE");
const u8 gText_MimicFree[] = _("Mimic{CLEAR_TO 0x4E}FREE");
const u8 gText_PayDayFree[] = _("Pay Day{CLEAR_TO 0x4E}FREE");
const u8 gText_GrassPledge4BP[] = _("Grass Pledge{CLEAR_TO 0x4E}4BP");
const u8 gText_FirePledge4BP[] = _("Fire Pledge{CLEAR_TO 0x4E}4BP");
const u8 gText_WaterPledge4BP[] = _("Water Pledge{CLEAR_TO 0x4E}4BP");
const u8 gText_FrenzyPlant8BP[] = _("Frenzy Plant{CLEAR_TO 0x4E}8BP");
const u8 gText_BlastBurn8BP[] = _("Blast Burn{CLEAR_TO 0x4E}8BP");
const u8 gText_HydroCannon8BP[] = _("Hydro Cannon{CLEAR_TO 0x4E}8BP");
const u8 gText_DracoMeteor12BP[] = _("Draco Meteor{CLEAR_TO 0x4E}12BP");
const u8 gText_SteelBeam12BP[] = _("Steel Beam{CLEAR_TO 0x4E}12BP");
const u8 gText_RelicSong16BP[] = _("Relic Song{CLEAR_TO 0x4E}16BP");
const u8 gText_SecretSword16BP[] = _("Secret Sword{CLEAR_TO 0x4E}16BP");
const u8 gText_DragonAscent16BP[] = _("Dragon Ascent{CLEAR_TO 0x4E}16BP");
const u8 gText_Uproar4BP[] = _("Uproar{CLEAR_TO 0x4E}4BP");
const u8 gText_Snore4BP[] = _("Snore{CLEAR_TO 0x4E}4BP");
const u8 gText_Bounce8BP[] = _("Bounce{CLEAR_TO 0x4E}8BP");
const u8 gText_LowKick8BP[] = _("Low Kick{CLEAR_TO 0x4E}8BP");
const u8 gText_ThunderPunch8BP[] = _("Thunder Punch{CLEAR_TO 0x4E}8BP");
const u8 gText_FirePunch8BP[] = _("Fire Punch{CLEAR_TO 0x4E}8BP");
const u8 gText_IcePunch8BP[] = _("Ice Punch{CLEAR_TO 0x4E}8BP");
const u8 gText_DrainPunch8BP[] = _("Drain Punch{CLEAR_TO 0x4E}8BP");
const u8 gText_TriAttack8BP[] = _("Tri Attack{CLEAR_TO 0x4E}8BP");
const u8 gText_Avalanche8BP[] = _("Avalanche{CLEAR_TO 0x4E}8BP");
const u8 gText_DarkestLariat8BP[] = _("Dark. Lariat{CLEAR_TO 0x4E}8BP");
const u8 gText_HeatWave12BP[] = _("Heat Wave{CLEAR_TO 0x4E}12BP");
const u8 gText_EarthPower12BP[] = _("Earth Power{CLEAR_TO 0x4E}12BP");
const u8 gText_KnockOff12BP[] = _("Knock Off{CLEAR_TO 0x4E}12BP");
const u8 gText_SuperFang12BP[] = _("Super Fang{CLEAR_TO 0x4E}12BP");
const u8 gText_DualChop12BP[] = _("Dual Chop{CLEAR_TO 0x4E}12BP");
const u8 gText_ThroatChop12BP[] = _("Throat Chop{CLEAR_TO 0x4E}12BP");
const u8 gText_HighHorsepower12BP[] = _("High Horsepwr{CLEAR_TO 0x4E}12BP");
const u8 gText_SkyDrop16BP[] = _("Sky Drop{CLEAR_TO 0x4E}16BP");
const u8 gText_Endeavor16BP[] = _("Endeavor{CLEAR_TO 0x4E}16BP");
const u8 gText_Liquidation16BP[] = _("Liquidation{CLEAR_TO 0x4E}16BP");
const u8 gText_SludgeWave16BP[] = _("Sludge Wave{CLEAR_TO 0x4E}16BP");
const u8 gText_Megahorn16BP[] = _("Megahorn{CLEAR_TO 0x4E}16BP");
const u8 gText_BugBite4BP[] = _("Bug Bite{CLEAR_TO 0x4E}4BP");
const u8 gText_Fling4BP[] = _("Fling{CLEAR_TO 0x4E}4BP");
const u8 gText_Reversal4BP[] = _("Reversal{CLEAR_TO 0x4E}4BP");
const u8 gText_DrillRun8BP[] = _("Drill Run{CLEAR_TO 0x4E}8BP");
const u8 gText_IronHead8BP[] = _("Iron Head{CLEAR_TO 0x4E}8BP");
const u8 gText_ZenHeadbutt8BP[] = _("Zen Headbutt{CLEAR_TO 0x4E}8BP");
const u8 gText_SignalBeam8BP[] = _("Signal Beam{CLEAR_TO 0x4E}8BP");
const u8 gText_BrutalSwing8BP[] = _("Brutal Swing{CLEAR_TO 0x4E}8BP");
const u8 gText_HyperVoice8BP[] = _("Hyper Voice{CLEAR_TO 0x4E}8BP");
const u8 gText_StoredPower8BP[] = _("Stored Power{CLEAR_TO 0x4E}8BP");
const u8 gText_AquaTail12BP[] = _("Aqua Tail{CLEAR_TO 0x4E}12BP");
const u8 gText_SeedBomb12BP[] = _("Seed Bomb{CLEAR_TO 0x4E}12BP");
const u8 gText_LastResort12BP[] = _("Last Resort{CLEAR_TO 0x4E}12BP");
const u8 gText_FoulPlay12BP[] = _("Foul Play{CLEAR_TO 0x4E}12BP");
const u8 gText_StompingTantrum12BP[] = _("StompTantrum{CLEAR_TO 0x4E}12BP");
const u8 gText_PollenPuff12BP[] = _("Pollen Puff{CLEAR_TO 0x4E}12BP");
const u8 gText_PsychicFangs12BP[] = _("Psychic Fangs{CLEAR_TO 0x4E}12BP");
const u8 gText_BodyPress12BP[] = _("Body Press{CLEAR_TO 0x4E}12BP");
const u8 gText_Outrage16BP[] = _("Outrage{CLEAR_TO 0x4E}16BP");
const u8 gText_Superpower16BP[] = _("Superpower{CLEAR_TO 0x4E}16BP");
const u8 gText_GunkShot16BP[] = _("Gunk Shot{CLEAR_TO 0x4E}16BP");
const u8 gText_SkyAttack16BP[] = _("Sky Attack{CLEAR_TO 0x4E}16BP");
const u8 gText_Bind4BP[] = _("Bind{CLEAR_TO 0x4E}4BP");
const u8 gText_Infestation4BP[] = _("Infestation{CLEAR_TO 0x4E}4BP");
const u8 gText_Covet4BP[] = _("Covet{CLEAR_TO 0x4E}4BP");
const u8 gText_Block8BP[] = _("Block{CLEAR_TO 0x4E}8BP");
const u8 gText_Quash8BP[] = _("Quash{CLEAR_TO 0x4E}8BP");
const u8 gText_RolePlay8BP[] = _("Role Play{CLEAR_TO 0x4E}8BP");
const u8 gText_PainSplit8BP[] = _("Pain Split{CLEAR_TO 0x4E}8BP");
const u8 gText_GastroAcid8BP[] = _("Gastro Acid{CLEAR_TO 0x4E}8BP");
const u8 gText_WorrySeed8BP[] = _("Worry Seed{CLEAR_TO 0x4E}8BP");
const u8 gText_Spite8BP[] = _("Spite{CLEAR_TO 0x4E}8BP");
const u8 gText_Trick8BP[] = _("Trick{CLEAR_TO 0x4E}8BP");
const u8 gText_Embargo8BP[] = _("Embargo{CLEAR_TO 0x4E}8BP");
const u8 gText_MagicCoat8BP[] = _("Magic Coat{CLEAR_TO 0x4E}8BP");
const u8 gText_Telekinesis8BP[] = _("Telekinesis{CLEAR_TO 0x4E}8BP");
const u8 gText_Charm12BP[] = _("Charm{CLEAR_TO 0x4E}12BP");
const u8 gText_Electroweb12BP[] = _("Electroweb{CLEAR_TO 0x4E}12BP");
const u8 gText_IcyWind12BP[] = _("Icy Wind{CLEAR_TO 0x4E}12BP");
const u8 gText_HoneClaws4BP[] = _("Hone Claws{CLEAR_TO 0x4E}4BP");
const u8 gText_IronDefense4BP[] = _("Iron Defense{CLEAR_TO 0x4E}4BP");
const u8 gText_LaserFocus4BP[] = _("Laser Focus{CLEAR_TO 0x4E}4BP");
const u8 gText_HealBell8BP[] = _("Heal Bell{CLEAR_TO 0x4E}8BP");
const u8 gText_MagicRoom8BP[] = _("Magic Room{CLEAR_TO 0x4E}8BP");
const u8 gText_WonderRoom8BP[] = _("Wonder Room{CLEAR_TO 0x4E}8BP");
const u8 gText_Gravity8BP[] = _("Gravity{CLEAR_TO 0x4E}8BP");
const u8 gText_MagnetRise8BP[] = _("Magnet Rise{CLEAR_TO 0x4E}8BP");
const u8 gText_Recycle8BP[] = _("Recycle{CLEAR_TO 0x4E}8BP");
const u8 gText_AfterYou8BP[] = _("After You{CLEAR_TO 0x4E}8BP");
const u8 gText_HelpingHand8BP[] = _("Helping Hand{CLEAR_TO 0x4E}8BP");
const u8 gText_Synthesis8BP[] = _("Synthesis{CLEAR_TO 0x4E}8BP");
const u8 gText_Defog8BP[] = _("Defog{CLEAR_TO 0x4E}8BP");
const u8 gText_AllySwitch12BP[] = _("Ally Switch{CLEAR_TO 0x4E}12BP");
const u8 gText_Tailwind12BP[] = _("Tailwind{CLEAR_TO 0x4E}12BP");
const u8 gText_ToxicSpikes12BP[] = _("Toxic Spikes{CLEAR_TO 0x4E}12BP");
const u8 gText_StealthRock12BP[] = _("Stealth Rock{CLEAR_TO 0x4E}12BP");
const u8 gText_DragonDance12BP[] = _("Dragon Dance{CLEAR_TO 0x4E}12BP");
const u8 gText_NastyPlot12BP[] = _("Nasty Plot{CLEAR_TO 0x4E}12BP");
const u8 gText_TerrainPulse12BP[] = _("Terrain Pulse{CLEAR_TO 0x4E}12BP");
const u8 gText_BurningJealousy12BP[] = _("Brn.Jealousy{CLEAR_TO 0x4E}12BP");
const u8 gText_FlipTurn12BP[] = _("Flip Turn{CLEAR_TO 0x4E}12BP");
const u8 gText_GrassyGlide12BP[] = _("Grassy Glide{CLEAR_TO 0x4E}12BP");
const u8 gText_RisingVoltage12BP[] = _("Rising Voltage{CLEAR_TO 0x4E}12BP");
const u8 gText_Coaching12BP[] = _("Coaching{CLEAR_TO 0x4E}12BP");
const u8 gText_ScorchingSands12BP[] = _("Scorch Sands{CLEAR_TO 0x4E}12BP");
const u8 gText_DualWingbeat12BP[] = _("Dual Wingbeat{CLEAR_TO 0x4E}12BP");
const u8 gText_MeteorBeam12BP[] = _("Meteor Beam{CLEAR_TO 0x4E}12BP");
const u8 gText_SkitterSmack12BP[] = _("Skitter Smack{CLEAR_TO 0x4E}12BP");
const u8 gText_TripleAxel12BP[] = _("Triple Axel{CLEAR_TO 0x4E}12BP");
const u8 gText_CorrosiveGas12BP[] = _("Corrosive Gas{CLEAR_TO 0x4E}12BP");
const u8 gText_ExpandingForce12BP[] = _("Expan. Force{CLEAR_TO 0x4E}12BP");
const u8 gText_Poltergeist12BP[] = _("Poltergeist{CLEAR_TO 0x4E}12BP");
const u8 gText_ScaleShot12BP[] = _("Scale Shot{CLEAR_TO 0x4E}12BP");
const u8 gText_LashOut12BP[] = _("Lash Out{CLEAR_TO 0x4E}12BP");
const u8 gText_SteelRoller12BP[] = _("Steel Roller{CLEAR_TO 0x4E}12BP");
const u8 gText_MistyExplosion12BP[] = _("Misty Explo.{CLEAR_TO 0x4E}12BP");
...
const u8 gText_BattleAnimations[] = _("Battle Anims.");
const u8 gText_BattleStyle[] = _("Battle Style");
const u8 gText_Speakers[] = _("Speakers");
const u8 gText_Music[] = _("Music");
const u8 gText_SFX[] = _("SFX");
const u8 gText_HpBar[] = _("HP Bar Speed");
const u8 gText_ExpBar[] = _("Exp. Bar Speed");
...
const u8 gText_AutoFieldMoves[] = _("Auto Field Moves");
const u8 gText_ItemHeaders[] = _("Item Headers");
const u8 gText_MatchCallFilter[] = _("Match Call Filter");
...
const u8 gText_HpExpBarSpeedDefault[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Default");
const u8 gText_BattleAnimationsOn[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}On");
const u8 gText_BattleAnimationsOff[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Off");
...
const u8 gText_SpeakersMono[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Mono");
const u8 gText_SpeakersStereo[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Stereo");
...
const u8 gText_ItemHeadersNever[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Never");
const u8 gText_ItemHeadersNewItems[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}New");
const u8 gText_ItemHeadersAlways[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Always");
const u8 gText_MatchCallFilterAllowAll[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Allow All{0x77}{0x77}{0x77}{0x77}{0x77}{0x77}{0x77}{0x77}");
const u8 gText_MatchCallFilterAllowScriptedAndRematchNotifs[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Scripted & Rematch{0x77}");
const u8 gText_MatchCallFilterAllowScriptedOnly[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Scripted Calls Only");
const u8 gText_ClockFormatAMPM[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}AM/PM");
const u8 gText_ClockFormat24Hr[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}24 Hr.");
...
const u8 gText_DifficultyChallenge[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Challenge");
...
const u8 gText_MoveRelearnerBattleMoves[] = _("Battle Info");
const u8 gText_MoveRelearnerContestMovesTitle[] = _("Contest Info");
...
const u8 gText_Stats_MoveReq_Lvl[]     = _("Lvl");
const u8 gText_Stats_MoveReq_Upon[]     = _("Upon");
const u8 gText_Stats_MoveReq_Evo[]     = _("Evo.");
const u8 gText_Stats_MoveReq_Tutor[]     = _("Tutor");
const u8 gText_Stats_MoveReq_Egg[]     = _("Egg");
const u8 gText_Stats_MoveReq_Move[]     = _("Move");
const u8 gText_Stats_Gender_0[]      = _("♀ 0:1 ♂");
...
const u8 gText_Stats_Gender_100[]    = _("♀ 1:0 ♂");
...
const u8 gText_EVO_MAPSEC[]                         = _("Lvl up in {STR_VAR_2}");
...
const u8 gText_EVO_SPECIFIC_MAP[]                   = _("Lvl up in {STR_VAR_2}");
...
const u8 gText_EVO_ITEM_HOLD[]                      = _("Lvl up, holds {STR_VAR_2}");
