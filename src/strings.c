...
const u8 gText_DynamicPunchFree[] = _("DynamicPunch{CLEAR_TO 0x4E}FREE");
...
const u8 gText_DragonPulse12BP[] = _("Dragon Pulse{CLEAR_TO 0x4E}12BP");
...
const u8 gText_AllySwitch8BP[] = _("Ally Switch{CLEAR_TO 0x4E}8BP");
