...
struct LoadedSaveData
{
 ...
 /*0x0230*/ struct ItemSlot competitive[BAG_COMPETITIVE_COUNT];
...
void LoadPlayerBag(void)
{
    ...
    for (i = 0; i < BAG_COMPETITIVE_COUNT; i++)
        gLoadedSaveData.competitive[i] = gSaveBlock1Ptr->bagPocket_Competitive[i];
...
void SavePlayerBag(void)
{
    ...
    for (i = 0; i < BAG_COMPETITIVE_COUNT; i++)
        gSaveBlock1Ptr->bagPocket_Competitive[i] = gLoadedSaveData.competitive[i];
