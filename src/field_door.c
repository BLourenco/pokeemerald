...
static const u8 sDoorAnimTiles_DevonLabExterior[] = INCBIN_U8("graphics/door_anims/devon_lab_outside.4bpp");
...
static const u8 sDoorAnimPalettes_DevonLabExterior[] = {1, 1, 1, 1, 1, 1, 1, 1};
...
static const struct DoorGraphics sDoorAnimGraphicsTable[] =
{
    ...
    {METATILE_Rustboro_Door_BattleTent,                     DOOR_SOUND_SLIDING, 1, sDoorAnimTiles_BattleTent, sDoorAnimPalettes_BattleTent},
    ...
    {METATILE_Dewford_LabDoor,                              DOOR_SOUND_NORMAL,  1, sDoorAnimTiles_DevonLabExterior, sDoorAnimPalettes_DevonLabExterior},
    {},
};
