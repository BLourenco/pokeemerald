...
static const u8 gRegionMapSectionId_To_PopUpThemeIdMapping[] =
{
    ...
    [MAPSEC_DEWFORD_COVE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_DEWFORD_CAPE - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_DRY_ASHLANDS - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_RED_CLAY_TUNNELS - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_STONE,    
    [MAPSEC_OVERGROWN_FOREST - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD,    
    [MAPSEC_ROUTE_135 - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_UNDERWATER,
    [MAPSEC_SHOAL_SUMMIT - KANTO_MAPSEC_COUNT] = MAPPOPUP_THEME_WOOD
};
