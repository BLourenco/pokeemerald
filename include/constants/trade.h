...
// In-game Trade IDs
#define INGAME_TRADE_ZIGZAGOON_GALARIAN 0
#define INGAME_TRADE_STUFFUL            1
#define INGAME_TRADE_DRIFLOON           2
#define INGAME_TRADE_BLITZLE            3
#define INGAME_TRADE_WOOLOO             4
