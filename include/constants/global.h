...
#define OPTIONS_SPEAKERS_MONO 0
#define OPTIONS_SPEAKERS_STEREO 1

#define OPTIONS_BATTLE_STYLE_SHIFT 0
#define OPTIONS_BATTLE_STYLE_SET 1

#define OPTIONS_UNIT_SYSTEM_METRIC      0
#define OPTIONS_UNIT_SYSTEM_IMPERIAL    1

#define OPTIONS_ITEM_HEADERS_NEVER_SHOW     0
#define OPTIONS_ITEM_HEADERS_ONLY_NEW_ITEMS 1
#define OPTIONS_ITEM_HEADERS_ALWAYS_SHOW    2

#define OPTIONS_MATCH_CALL_FILTER_ALLOW_ALL                         0
#define OPTIONS_MATCH_CALL_FILTER_ALLOW_SCRIPTED_AND_REMATCH_NOTIF  1
#define OPTIONS_MATCH_CALL_FILTER_ALLOW_SCRIPTED_ONLY               2

#define OPTIONS_CLOCK_FORMAT_AM_PM  0
#define OPTIONS_CLOCK_FORMAT_24_HR  1

#define OPTIONS_DIFFICULTY_EASY      0
#define OPTIONS_DIFFICULTY_NORMAL    1
#define OPTIONS_DIFFICULTY_CHALLENGE 2
