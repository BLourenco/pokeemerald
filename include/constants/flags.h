...
#define FLAG_HIDE_PETALBURG_WOODS_HEADBUTT_GIRL                     0x409 // leftover from R/S. In Emerald this is a hidden item and uses a different flag
...
#define DAILY_FLAGS_END                             (FLAG_UNUSED_0x94F + (7 - FLAG_UNUSED_0x94F % 8))
